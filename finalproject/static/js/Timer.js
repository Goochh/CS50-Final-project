export default class Timer {
    constructor(root) {
        ...
        this.el = {
            ...
            stopStart: root.querySelector(".timer__btn--control"),
        ...
        this.el.reset.addEventListener("click", () => {
            const inputMinutes = prompt("Time:");
    ...
    updateInterfaceControls(){
        if (this.interval === null){
            this.el.stopStart.innerHTML = `<span class="material-icons">play_arrow</span>`;
            this.el.stopStart.classList.add("timer__btn--start");
            this.el.stopStart.classList.remove("timer__btn--stop");
        }   else{
            this.el.stopStart.innerHTML = `<span class="material-icons">pause</span>`;
